        ...
        if (t.id === selectedTarget.id) {
          const updatedVulns = t.vulnerabilities.map(v => {
            if (v.id === vulnId) {
              return {
                ...v,
                chatHistory: v.chatHistory.filter(msg => !msg.isTyping)
              };
            }
            return v;
          });
                  ...
                  {(() => {
                    ...
                    return sortedDates.map(dateStr => (
                      <div key={dateStr} style={{ marginBottom: 24 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, backgroundColor: 'rgba(255,255,255,0.02)', padding: 12, borderRadius: 12, border: '1px solid rgba(255,255,255,0.05)' }}>
