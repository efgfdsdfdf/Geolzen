...
=========================================
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'row', backgroundColor: 'var(--bg-main)' }}>
      ...
      {/* Global Strip */}
      <div style={{ width: 64, backgroundColor: 'var(--bg-strip)', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '16px 0', borderRight: '1px solid var(--border-color)', zIndex: 10, flexShrink: 0 }}>
      ...
      {/* Secondary Sidebar */}
      <div style={{ width: 250, backgroundColor: 'var(--bg-panel)', display: 'flex', flexDirection: 'column', borderRight: '1px solid var(--border-color)', zIndex: 9, height: '100vh', overflowY: 'auto', flexShrink: 0 }}>
