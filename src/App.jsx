  ...
  return (
    <div className="app-layout-wrapper" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'row', backgroundColor: 'var(--bg-main)' }}>
      ...
      <div className={`mobile-nav-overlay ${isMobileMenuOpen ? 'open' : ''}`}>
        ...
        <button onClick={() => selectTab('scans')} style={{ width: '100%', textAlign: 'left', padding: '12px 16px', borderRadius: 6, background: activeTab === 'scans' ? 'var(--accent-primary)' : 'transparent', color: activeTab === 'scans' ? '#fff' : 'var(--text-primary)', border: 'none', display: 'flex', alignItems: 'center', gap: 12, fontSize: '1.1rem' }}>
      ...
      <div className="desktop-sidebar" style={{ width: 250, backgroundColor: 'var(--bg-panel)', display: 'flex', flexDirection: 'column', borderRight: '1px solid var(--border-color)', zIndex: 9, height: '100vh', overflowY: 'auto', flexShrink: 0 }}>
         ...
         {/* Workspace Selector */}
         <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }}>
         ...
         <div style={{ padding: '24px 12px' }}>
            <button onClick={() => {}} style={{ width: '100%', textAlign: 'left', padding: '8px 12px', background: 'transparent', color: 'var(--text-secondary)', border: 'none', display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer', fontSize: '0.9rem', marginBottom: 24 }}>
               ← Environment
            </button>
      ...
      <div style={{ flex: 1, height: '100vh', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="main-content-area" style={{ padding: '32px', maxWidth: '1200px', width: '100%' }}>
